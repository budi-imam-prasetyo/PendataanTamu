            ...
            <div class="flex flex-wrap">
                ...
                <div class="w-1/5">
                    <div style="min-height: 100dvh"
                        class="w-full sm:relative bg-gray-800 shadow md:h-full flex-col justify-between hidden sm:flex fixed">
                        <div class="px-8">
                            <div class="h-16 w-full flex items-center my-5">
                                <div class="w-1/4">
                            ...
                            <ul class="w-full flex items-center justify-between bg-gray-800">
                                ...
                                <li class="cursor-pointer text-white pt-5 pb-3">
                                    <button aria-label="open chats"
                                        class="focus:outline-none focus:ring-2 rounded focus:ring-gray-300">
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="icon icon-tabler icon-tabler-messages" width="20" height="20"
                                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none"
                                            stroke-linecap="round" stroke-linejoin="round">
                                            <path stroke="none" d="M0 0h24v24H0z"></path>
                    ...
                    <div class="w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out"
                        ...
                        <div class="px-8">
                            <div class="h-16 w-full flex items-center">
                                <svg aria-label="Ripples. Logo" role="img" xmlns="http://www.w3.org/2000/svg" width="144"
                                    height="30" viewBox="0 0 144 30">
                                    <path fill="#5F7DF2"
