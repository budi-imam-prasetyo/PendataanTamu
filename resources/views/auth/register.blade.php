                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input id="name" type="text" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-hijau outline-none" name="name"
                        ...
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input id="email" type="email" name="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-hijau outline-none" value="{{ old('email') }}" required autocomplete="email" placeholder="Masukan Alamat Email">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-12">
                                <label for="password" class="text-xs font-semibold px-1">{{ __('Password') }}</label>
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                    <input id="password" type="password" name="password" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-hijau outline-none" required autocomplete="new-password" placeholder="********">
                                </div>
                            </div>
                            <div class="w-1/2 px-3 mb-12">
                                <label for="password-confirm" class="text-xs font-semibold px-1">{{ __('Confirm Password') }}</label>
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-lock-outline text-gray-400 text-lg"></i></div>
                                    <input id="password-confirm" type="password" name="password_confirmation" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-hijau outline-none" required autocomplete="new-password" placeholder="********">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                <button class="block w-full max-w-xs mx-auto bg-hijau hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">{{ __('Register') }}</button>
                            </div>
                        </div>
                    </div>
                </form>
