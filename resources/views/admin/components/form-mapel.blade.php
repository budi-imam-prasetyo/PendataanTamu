<div class="mb-5">
    ...
    <div class="card col-span-2 xl:col-span-1 mt-6">
        ...
        <form action="{{ route('admin.mapel') }}" method="post" class="flex flex-col w-full p-6 mx-auto mt-10 bg-white border rounded-2xl shadow-md dark:bg-slate-850 dark:border-transparent dark:shadow-dark-xl">
            ...
            <input type="text" name="nama" required class="w-full px-3 py-2 mb-3 border rounded-md focus:outline-none focus:border-blue-400 dark:bg-slate-850 dark:border-transparent dark:text-white">
