                ...
                <div class="p-0 overflow-x-auto rounded-b-2xl">
                    <table
                        ...
                        <thead class="align-bottom">
                            <tr>
                                <th
                                    class="px-6 py-3 font-bold text-left uppercase align-middle bg-blue-100 dark:bg-slate-800 border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xs border-b-solid tracking-none whitespace-nowrap text-slate-400">
                                    Nama
                                </th>
                                <th
                                    class="px-6 py-3 font-bold text-left uppercase align-middle bg-blue-100 dark:bg-slate-800 border-b border-collapse shadow-none dark:border-white/40 dark:text-white text-xs border-b-solid tracking-none whitespace-nowrap text-slate-400">
                            ...
                            @foreach ($guru as $guru)
                                <tr
                                    ...
                                    <td
                                        class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                        <button type="button"
                                            onclick="showUpdateForm('{{ $guru->email }}', '{{ $guru->name }}', '{{ $guru->email }}')"
                                            class="text-xs font-semibold leading-tight text-white bg-blue-500 hover:bg-blue-600 py-1 px-2 rounded-l -m-1">
                                            Update
                                        </button>
