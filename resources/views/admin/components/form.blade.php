<div class="mb-5">
    ...
    <form action="{{ route('admin.addGuru') }}" method="post" class="flex flex-col w-full p-6 mx-auto mt-10 bg-white border rounded-2xl shadow-md dark:bg-slate-850 dark:border-transparent dark:shadow-dark-xl">
        ...
        <input type="text" name="name" required class="w-full px-3 py-2 mb-3 border rounded-md focus:outline-none focus:border-blue-400 dark:bg-slate-850 dark:border-transparent dark:text-white">
    
        <label for="inputEmail" class="block mb-2 text-sm font-semibold text-gray-600 dark:text-white">Email</label>
        <input type="text" name="email" required class="w-full px-3 py-2 mb-3 border rounded-md focus:outline-none focus:border-blue-400 dark:bg-slate-850 dark:border-transparent dark:text-white">
    
        <label for="inputPassword" class="block mb-2 text-sm font-semibold text-gray-600 dark:text-white">Password</label>
        <input type="password" name="password" required class="w-full px-3 py-2 mb-4 border rounded-md focus:outline-none focus:border-blue-400 dark:bg-slate-850 dark:border-transparent dark:text-white">
    ...
    <form id="updateForm" action="{{ route('admin.updateGuru') }}" method="post" style="display: none;" onsubmit="return validateUpdateForm()" class="flex flex-col w-full p-6 mx-auto mt-10 bg-white border rounded-2xl shadow-md dark:bg-slate-850 dark:border-transparent dark:shadow-dark-xl">
        ...
        <input type="text" name="newEmail" id="newEmail" class="w-full px-3 py-2 mb-3 border rounded-md focus:outline-none focus:border-blue-400 dark:bg-slate-850 dark:border-transparent dark:text-white">
    
        <label for="newPassword" class="block mb-2 text-sm font-semibold text-gray-600 dark:text-white">Password</label>
        <input type="password" name="newPassword" id="newPassword" class="w-full px-3 py-2 mb-4 border rounded-md focus:outline-none focus:border-blue-400 dark:bg-slate-850 dark:border-transparent dark:text-white">
